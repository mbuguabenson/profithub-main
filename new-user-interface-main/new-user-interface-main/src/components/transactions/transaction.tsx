            ...
            >
                ...
                <div className='transactions__cell transactions__entry-spot'>
                    <TransactionIconWithText
                        ...
                        message={
                            contract?.entry_spot !== undefined && contract?.entry_spot !== null ? (
                                <TransactionSpotValue value={contract.entry_spot} />
                            ) : (
                ...
                <div className='transactions__cell transactions__exit-spot'>
                    <TransactionIconWithText
                        ...
                        message={
                            contract?.exit_spot !== undefined && contract?.exit_spot !== null ? (
                                <TransactionSpotValue value={contract.exit_spot} />
                            ) : (
                                <TransactionFieldLoader />
                            )
                        }
