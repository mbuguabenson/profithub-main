...
const TransactionItem = (props: TTransactionItem) => {
    const { row, onClickTransaction, active_transaction_id } = props;
                    ...
                    {transaction_list?.length ? (
                        <DataList
                            ...
                            keyMapper={row => {
                                switch (row.type) {
                                    case transaction_elements.CONTRACT: {
                                        return row.data?.transaction_ids?.buy ?? row.data?.contract_id ?? Math.random().toString();
                                    }
                                    case transaction_elements.DIVIDER: {
                                        return row.data;
                                    }
