...
window.Blockly.Blocks.trade_definition_alternate_markets = {
    init() {
        this.jsonInit({
            ...
            message1: localize('Scan all volatility markets simultaneously: {{ checkbox }}', {
                checkbox: '%1',
            }),
            args1: [
                {
                    type: 'field_checkbox',
                    name: 'SCAN_ALL_VOLATILITY',
                    checked: false,
                },
            ],
            message2: localize('Virtual Hook: {{ checkbox }} {{ vh_btn }}', {
                checkbox: '%1',
                vh_btn: '%2',
            }),
            args2: [
                ...
                {
                    type: 'field_image',
                    src: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="90" height="24" viewBox="0 0 90 24"><rect width="90" height="24" rx="12" fill="%23fb8500"/><text x="45" y="16" fill="%23ffffff" font-size="11" font-weight="bold" font-family="sans-serif" text-anchor="middle">VH Settings</text></svg>',
                    width: 90,
                    height: 24,
                    alt: 'VH Settings',
                    onClick: function () {
