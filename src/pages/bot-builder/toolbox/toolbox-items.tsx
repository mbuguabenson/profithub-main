    ...
    ReactDomServer.renderToStaticMarkup(
        <Xml xmlns='http://www.w3.org/1999/xhtml' id='toolbox'>
            ...
            <Category id='analysis' name={localize('Analysis')}>
                <Category name={localize('AI Market Scanner')} id='ai_scanner'>
                    <Block type='scanner_best_market' />
                    <Block type='scanner_last_digit' />
                    <Block type='scanner_signal_confidence' />
                    <Block type='scanner_over_under_bias' />
                    <Block type='scanner_coldest_digit' />
                    <Block type='scanner_hottest_digit' />
                    <Block type='scanner_is_strong_signal' />
                </Category>
