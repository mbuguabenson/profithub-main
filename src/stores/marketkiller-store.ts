...
export default class MarketkillerStore {
    ...
    public subscribeToTicks = async () => {
        ...
        try {
            ...
            if (this.tick_listener_sub) {
                try { this.tick_listener_sub.unsubscribe(); } catch (e) {}
                this.tick_listener_sub = null;
            }
    ...
    private ribbon_listener_sub: any = null;
    ...
    private subscribeToRibbon = async () => {
        ...
        if (this.ribbon_listener_sub) {
            try { this.ribbon_listener_sub.unsubscribe(); } catch (e) {}
            this.ribbon_listener_sub = null;
        }

        this.ribbon_listener_sub = api_base.api.onMessage().subscribe((res: any) => {
